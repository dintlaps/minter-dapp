const contractAddress = "0x108001A68A009DD4494DEA91d8961ce3a112368f"; //Replace with your own contract address
const chain = 'rinkeby'; // rinkeby or polygon

const welcome_h1 = "Welcome to the Dint Clubbers NFT Project!!";
const welcome_h2 = "Connect to MetaMask to Get Started";
const welcome_p = 'Ownership of a Dint Clubber Key Collection NFT grants you lifetime access to Dint Music Festival as well as member-only benefits.';
...
const p_prele_mint_already_minted = "You've already claimed your whitelist mint. Thank you! 🎉";
