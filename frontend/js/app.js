...
var App_URL = "dint.netlify.app"


// mobile checking logic
  ...
  if (!MetaMaskOnboarding.isMetaMaskInstalled()) {
    ...
    onboardButton.onclick = () => {
      ...
      if(window.mobileCheck() == true){
        window.location.replace("http://metamask.app.link/dapp/"+App_URL)
      } 
      else{
...
async function loadInfo() {
  ...
  if (publicMintActive) {
    ...
    try {
      ...
      // console.log(e);
    //  p_presale_mint_already_minted is not defined error coming so i declared it here
    // delete it if not needed
      var p_presale_mint_already_minted ="You are not whitelisted for the pre-sale..";
